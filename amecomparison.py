...
directory = '/Users/mpeel/Documents/Quijote/AME/202005_comparison/'
filenames = ['AME_nl_Gal.fits','AME_nl_Hlat.fits','AMEfreq_nl_Gal.fits','AMEfreq_nl_Hlat.fits','FF_nl_Gal.fits','FF_nl_Hlat.fits','mask_hlat_gal_combined_2019.fits','sigma_nl_Gal.fits','sigma_nl_Hlat.fits','Synch_nl_Gal.fits','Synch_nl_Hlat.fits','mask_SN_T.fits']
indir = directory+''
...
for filename in filenames:
	...
	hp.mollview(mapdata,xsize=4000)
	plt.savefig(outdir+filename+'_plot_lin.pdf')
