...
freqs = [22.8,33.0,40.7,60.7,93.5,28.4,44.1,70.4,100.0,143.0,217.0,353.0]
quijote_map = '/Users/mpeel/Documents/QUIJOTE/m31/mapsds_iqu_m31_comb_rasters_931td_rgs_nominal_oct2018_ctod_ns512.fits'
outdir = '/Users/mpeel/Documents/QUIJOTE/m31/comparison_zoom/'

cbass_map = '/Users/mpeel/Documents/maps/cbass_global8p8deg_swapQU_NIGHT_v28allelsNs_37_noiseCut_masked5pc_G_1024_ol500_lessTol_g_map_g_1deg_0256.fits'
...
for i in range(0,nummaps):
	for j in range(0,2): # Pol
		...
		plt.clf()
		units='mK_CMB'
		print(haperflux(newmap, freqs[i], res_arcmin, lon, lat, aper_inner_radius, aper_outer_radius1, aper_outer_radius2, units, column=0, dopol=False, nested=False, noise_model=noise_model, abratio=0.7, angle=45.0, silent=False))
